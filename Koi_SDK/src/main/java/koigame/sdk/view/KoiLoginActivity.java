...
public class KoiLoginActivity extends HActivityBase {
    ...
    public void forgetPwd(View view) {
        Intent intent = new Intent(this, KoiForgetPwdActivity.class);
        ActivityOptionsCompat compat = ActivityOptionsCompat.makeCustomAnimation(this, RUtils.getAnimId("slide_in_left"), RUtils.getAnimId("slide_in_right"));
        ...
        windowLayoutParams.width = (int) (dm.widthPixels * 0.81); // 宽度设置为屏幕的0.95
        windowLayoutParams.height = (int) (dm.heightPixels * 0.48); // 高度设置为屏幕的0.6*/
    }
