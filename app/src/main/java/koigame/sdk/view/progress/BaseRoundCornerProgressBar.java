...
public abstract class BaseRoundCornerProgressBar extends LinearLayout {
    ...
    public void setup(Context context, AttributeSet attrs) {
        ...
        layoutBackground = (LinearLayout) findViewById(RUtils.getViewId("layout_background"));
        layoutProgress = (LinearLayout) findViewById(RUtils.getViewId("layout_progress"));
        layoutSecondaryProgress = (LinearLayout) findViewById(RUtils.getViewId("layout_secondary_progress"));
    ...
    public void setupStyleable(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, new int[]{RUtils.getStyleableId("RoundCornerProgress")});

        radius = (int) typedArray.getDimension(RUtils.getStyleableId("RoundCornerProgress_rcRadius"), dp2px(DEFAULT_PROGRESS_RADIUS));
        padding = (int) typedArray.getDimension(RUtils.getStyleableId("RoundCornerProgress_rcBackgroundPadding"), dp2px(DEFAULT_BACKGROUND_PADDING));

        isReverse = typedArray.getBoolean(RUtils.getStyleableId("RoundCornerProgress_rcReverse"), false);

        max = typedArray.getFloat(RUtils.getStyleableId("RoundCornerProgress_rcMax"), DEFAULT_MAX_PROGRESS);
        progress = typedArray.getFloat(RUtils.getStyleableId("RoundCornerProgress_rcProgress"), DEFAULT_PROGRESS);
        secondaryProgress = typedArray.getFloat(RUtils.getStyleableId("RoundCornerProgress_rcSecondaryProgress"), DEFAULT_SECONDARY_PROGRESS);

        int colorBackgroundDefault = context.getResources().getColor(RUtils.getColorId("round_corner_progress_bar_background_default"));
        colorBackground = typedArray.getColor(RUtils.getStyleableId("RoundCornerProgress_rcBackgroundColor"), colorBackgroundDefault);
        int colorProgressDefault = context.getResources().getColor(RUtils.getColorId("round_corner_progress_bar_progress_default"));
        colorProgress = typedArray.getColor(RUtils.getColorId("RoundCornerProgress_rcProgressColor"), colorProgressDefault);
        int colorSecondaryProgressDefault = context.getResources().getColor(RUtils.getColorId("round_corner_progress_bar_secondary_progress_default"));
        colorSecondaryProgress = typedArray.getColor(RUtils.getColorId("RoundCornerProgress_rcSecondaryProgressColor"), colorSecondaryProgressDefault);
        typedArray.recycle();
